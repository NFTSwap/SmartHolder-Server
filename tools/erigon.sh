...
/home/blue/Install/erigon_2.53.4_linux_amd64/erigon \
	--datadir=/data/polygon/erigon --chain=bor-mainnet --ethash.dagdir=/data/polygon/erigon/ethash --snapshots=false \
	...
	--http.api=eth,debug,net,trace,web3,erigon,bor --ws --ws.compression --rpc.gascap=300000000 --verbosity=5  --internalcl \
...
heimdalld rollback --home=/data/polygon/heimdall --chain-id="mainnet-137"
heimdalld tendermint show-node-id --home=/data/polygon/heimdall
# polygon bor
# port=8845 p2p=30323
...
# download bor-erigon and heimdall snapshow
...
nohup curl -L https://snapshot-download.polygon.technology/snapdown.sh | bash -s -- --network mainnet --client bor --extract-dir bor-snapshow --validate-checksum true >/dev/null 2>&1 &
